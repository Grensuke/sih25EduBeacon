    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-primary-400 mb-6">
            AI-Powered
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="card text-primary-400">
            <div className="text-4xl mb-4">🤖</div>
            <h3 className="text-2xl font-bold mb-4 text-primary-400">AI Counseling</h3>
          ...
          <div className="card text-primary-400">
            <div className="text-4xl mb-4">📊</div>
            <h3 className="text-2xl font-bold mb-4 text-primary-400">Analytics Dashboard</h3>
            <p className="text-slate-200 leading-relaxed">
          ...
          <div className="card text-primary-400">
            <div className="text-4xl mb-4\">👥</div>
            <h3 className="text-2xl font-bold mb-4 text-primary-400">Mentor Support</h3>
            <p className="text-slate-200 leading-relaxed">
